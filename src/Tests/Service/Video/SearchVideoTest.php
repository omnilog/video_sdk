...
/**
 * Description of SearchVideoTest
 *
 * @author cguinet
 */
class SearchVideoTest extends \PHPUnit_Framework_TestCase {
    public function testExecute() {
        ...
        $mockSerializerSvc
            ...
            ->willReturn(array('serialize-search'));
        ...
        $svc = new \Lequipe\Service\Video\SearchVideo();
